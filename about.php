...
<div class=" about_Two">
    ...
    <div class="about_simpleHeader_text_Two ">
        ...
        <p> Welcome to our family-run granite business! With nearly five years of experience, we specialize in
            kitchens, bathrooms, bar tops, and outdoor spaces.</p><br>
        <p>We’re passionate about delivering quality craftsmanship and making your vision a reality. Our hardworking
            team takes pride in every project, ensuring care, precision, and your satisfaction every step of the
            way.</p><br>
        ...
        <div class="accordion-div">
            ...
            <div class="panel">
                ...
                <div class="accordion_text">
                    ...
                    <button class="stonePageButton"><a href="contact.php#slabView">Check out the Stones!</a>
                    </button>
                </div>
            </div>
            <button class="accordion">Templating</button>
            <div class="panel">
                <p>2. After Choosing the stone and once your happy with the price we next will template your kitchen
                    to ready for the fabrication</p>
                <img src="" alt="Templating">
            </div>
...
<div class="about_Highlights">
    <div class="about_list">
        ...
        <div class="items">
            ...
            <div class="explore">
                <a href="portfolio.php" class="answer">Explore Our Projects</a>
            </div>
